...
static float const kPopoverViewHeight = 160.f; ///< 箭头高度
...
#pragma mark -- 修改pop弹窗 高度
    CGFloat maxHeight = _isUpward ? 173 : (toPoint.y - CGRectGetHeight([UIApplication sharedApplication].statusBarFrame));
